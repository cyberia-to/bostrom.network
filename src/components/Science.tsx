      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <motion.a
            ...
            className="group relative p-8 rounded-2xl border border-primary/30 bg-card/50 backdrop-blur-sm hover:border-primary/60 transition-all duration-300 cursor-pointer"
          >
            ...
            <h3 className="text-2xl font-orbitron font-bold text-foreground group-hover:text-primary transition-colors duration-300">
              Collective Focus Theorem
            </h3>
            <p className="mt-3 text-muted-foreground group-hover:text-foreground/80 transition-colors duration-300">
